...
<div class="entrance1">
  <div class="entrance">
    ...
    <div class="entrance_pages">
      <a href="{{ route('login') }}" class="login_page">Login</a>
      <div class="line_page"></div>
      <a href="" class="register_page">Register</a>
    </div>
    ...
    <form action="{{ route('register') }}" method="POST">
      @csrf
      <div class="username">
        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Username" value="{{ old('name') }}" required autocomplete="name" autofocus>
      ...
      <div class="form_login">
        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Enter your email address" value="{{ old('email') }}" required autocomplete="email">
      ...
      <div class=" form_register">
        <input type="password" name="password_confirmation" class="form-control" id="configPassword" placeholder="Confirm Password" required autocomplete="new-password">
      </div>


      <div class="transition_register"><a href="">Forgot Password?</a></div>
      <div class="login"><a href="{{ route('user') }}"> {{ __('Register') }}</a></div>
    </form>
    <div class="by_using">
